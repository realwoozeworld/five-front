        ...
        return (
            <React.Fragment>
                <div className="hud__speedometr"
                    style={{
                        backgroundImage: this.state.isShowSmall ? 'none' : `url('/client/images/icons/hud/speedometer-bg.svg')`,
                    ...
                    <img
                        src={this.state.light ? `/client/images/icons/hud/light_on.svg` : `/client/images/icons/hud/light_default_on.svg`}
                        className="hud__speedometr__light-on"
                    />
                    <img
                        src={this.state.light ? `/client/images/icons/hud/light_default_off.svg` : `/client/images/icons/hud/light_off.svg`}
                        className="hud__speedometr__light-off"
                    />
                    <img
                        src={this.state.door ? `/client/images/icons/hud/car_lock_off_default.svg` : `/client/images/icons/hud/car_lock_off.svg`}
                        className="hud__speedometr__door-on"
                    />
                    <img
                        src={this.state.door ? `/client/images/icons/hud/car_lock_on.svg` : `/client/images/icons/hud/car_lock_on_default.svg`}
                        className="hud__speedometr__door-off"
                    />
                    <img
                        src={this.state.turnLeft ? `/client/images/icons/hud/arrow_left_on.svg` : `/client/images/icons/hud/arrow_left_off.svg`}
                        className="hud__speedometr__arrow-left"
                    />
                    <img
                        src={this.state.turnRight ? `/client/images/icons/hud/arrow_right_on.svg` : `/client/images/icons/hud/arrow_right_off.svg`}
                        className="hud__speedometr__arrow-right"
                    />
                    <div className="hud__speedometr__info">
                        <div className="hud__speedometr__info__row">
                            <img
                                src={this.state.fuelType === '%' ? `/client/images/icons/hud/power.svg` : `/client/images/icons/hud/fuel.svg`}
