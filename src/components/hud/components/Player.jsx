                    ...
                    <div className="player-hud__box">
                        <div className="player-hud__box__row">
                            <Draggable id="player-money" className="phud-money">
                                <div className="money-box">
                                    ...
                                    <img src={`/client/images/icons/hud/paper_money.svg`} width="13" />
                                </div>
                                <div className="money-box">
                                    <div className="credit-text">{this.state.card}</div>
                                    <img src={`/client/images/icons/hud/card_money.svg`} width="13" />
                                </div>
                            </Draggable>
                            <Draggable id="player-mic" className="phud-mic" style={{backgroundColor: 'rgba(0, 0, 0, ' + this.state.background + ')'}}>
                                <img src={this.state.microphone ? `/client/images/icons/hud/mic_on.svg` : `/client/images/icons/hud/mic-off.svg`} width="24" />
                            </Draggable>
                        </div>
                        <Draggable id="player-needs" className="phud-needs" style={{backgroundColor: 'rgba(0, 0, 0, ' + this.state.background + ')'}}>
                                <div className="needs-box">
                                    ...
                                    <img src={`/client/images/icons/hud/drink.svg`} width="10" style={{filter: this.state.drink <= 20 ? 'invert(57%) sepia(78%) saturate(6251%) hue-rotate(337deg) brightness(133%) contrast(113%)' : 'none'}} />
                                </div>
                                <div className="needs-box">
                                    ...
                                    <img src={`/client/images/icons/hud/eat.svg`} style={{filter: this.state.eat <= 20 ? 'invert(57%) sepia(78%) saturate(6251%) hue-rotate(337deg) brightness(133%) contrast(113%)' : 'none'}} width="12" />
                                </div>
                        </Draggable>
                    </div>
                </div>
